        ...
        <div className="space-y-8 text-sm leading-relaxed text-[#4A4A4A] md:text-[15px]">
          <section>
            <h2 className="mb-3 flex items-center gap-2 text-base font-bold text-[#1E1E1E] md:text-lg">
              <ShoppingBag size={18} className="text-[#7C3AED]" /> 1. Overview & General Terms
            </h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 flex items-center gap-2 text-base font-bold text-[#1E1E1E] md:text-lg">
              <AlertCircle size={18} className="text-[#7C3AED]" /> 2. Product Pricing & Accuracy
            </h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 flex items-center gap-2 text-base font-bold text-[#1E1E1E] md:text-lg">
              <Truck size={18} className="text-[#7C3AED]" /> 3. Orders & Cash on Delivery (COD)
            </h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 flex items-center gap-2 text-base font-bold text-[#1E1E1E] md:text-lg">
              <ShieldAlert size={18} className="text-[#7C3AED]" /> 4. Governing Law & Jurisdiction
            </h2>
            <p>
